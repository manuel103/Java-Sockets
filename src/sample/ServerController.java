...
public class ServerController implements Initializable {
    ...
    public void requestToyName(ActionEvent actionEvent){
        if(server.isConnected()){
            serverMessageBoard.appendText("|"+Util.Companion.getCurrentDateTime()+"| "+ Messages.MESSAGE_A+"\n");
            try {
    ...
    public void requestMessage(ActionEvent actionEvent){
        if(server.isConnected()){
            serverMessageBoard.appendText("|"+Util.Companion.getCurrentDateTime()+"| "+ Messages.MESSAGE_D+"\n");
            try {
    ...
    public void requestManufacturerDetails(ActionEvent actionEvent){
        if(server.isConnected()){
            serverMessageBoard.appendText("|"+Util.Companion.getCurrentDateTime()+"| "+ Messages.MESSAGE_C+"\n");
            try {
    ...
    public void requestToyInformation(ActionEvent actionEvent){
        if(server.isConnected()){
            serverMessageBoard.appendText("|"+Util.Companion.getCurrentDateTime()+"| "+ Messages.MESSAGE_B+"\n");
            try {
    ...
    public void requestAllToyInformation(ActionEvent actionEvent){
        if(server.isConnected()){
            serverMessageBoard.appendText("|"+Util.Companion.getCurrentDateTime()+"| "+ Messages.MESSAGE_E+"\n");
            try {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        requestToyInformation.setOnAction(this::requestToyInformation);
        requestAllToyInformation.setOnAction(this::requestAllToyInformation);
    }

    public void postToy(ToyMerchant clientToyMerchant) {

        serverMessageBoard.appendText("|"+Util.Companion.getCurrentDateTime()+"|"+" Client : "+Util.Companion.printToyObject(clientToyMerchant)+"\n");
    }
